...
from util_graph import TimeAxisItem, timestamp
...
class MyWindow(QMainWindow):
    ...
    def display_widget(self):
        ...
        #MPPTs Graph
        self.mppt1_input_data['y'].append(new_y)
        self.mppt1_output_data['y'].append(new_y1)
        ...
        self.mppt2_input_data['y'].append(new_y)
        self.mppt2_output_data['y'].append(new_y1)
        ...
        self.mppt3_input_data['y'].append(new_y)
        self.mppt3_output_data['y'].append(new_y1)
        ...
        self.mppt4_input_data['y'].append(new_y)
        self.mppt4_output_data['y'].append(new_y1)
        ...
        #MC graphs
        self.buspwr_data['y'].append(new_y)
        self.velocity_data['y'].append(new_y1)
        ...
        #MPPT 
        self.mppt1_modeval.setText(str(self.pw_out))
        self.mppt1_input_voltval.setText(str(self.pw_out))
        self.mppt1_input_currentval.setText(str(self.pw_out))
        self.mppt1_input_powerval.setText(str(self.pw_out))
        self.mppt1_limitsval.setText(str(self.pw_out))
        self.mppt1_output_voltval.setText(str(self.pw_out))
        self.mppt1_output_currentval.setText(str(self.pw_out))
        self.mppt1_output_powerval.setText(str(self.pw_out))
        self.mppt1_errorval.setText(str(self.pw_out))
        self.mppt1_mosfetval.setText(str(self.pw_out))
        self.mppt1_cntrlval.setText(str(self.pw_out))
        self.mppt1_pwrcntrlval.setText(str(self.pw_out))
        self.mppt1_aux12val.setText(str(self.pw_out))
        self.mppt1_aux3val.setText(str(self.pw_out))
        self.mppt1_output_batteryval.setText(str(self.pw_out))

        self.mppt2_modeval.setText(str(self.pw_out))
        self.mppt2_input_voltval.setText(str(self.pw_out))
        self.mppt2_input_currentval.setText(str(self.pw_out))
        self.mppt2_input_powerval.setText(str(self.pw_out))
        self.mppt2_limitsval.setText(str(self.pw_out))
        self.mppt2_output_voltval.setText(str(self.pw_out))
        self.mppt2_output_currentval.setText(str(self.pw_out))
        self.mppt2_output_powerval.setText(str(self.pw_out))
        self.mppt2_errorval.setText(str(self.pw_out))
        self.mppt2_mosfetval.setText(str(self.pw_out))
        self.mppt2_cntrlval.setText(str(self.pw_out))
        self.mppt2_pwrcntrlval.setText(str(self.pw_out))
        self.mppt2_aux12val.setText(str(self.pw_out))
        self.mppt2_aux3val.setText(str(self.pw_out))
        self.mppt2_output_batteryval.setText(str(self.pw_out))

        self.mppt3_modeval.setText(str(self.pw_out))
        self.mppt3_input_voltval.setText(str(self.pw_out))
        self.mppt3_input_currentval.setText(str(self.pw_out))
        self.mppt3_input_powerval.setText(str(self.pw_out))
        self.mppt3_limitsval.setText(str(self.pw_out))
        self.mppt3_output_voltval.setText(str(self.pw_out))
        self.mppt3_output_currentval.setText(str(self.pw_out))
        self.mppt3_output_powerval.setText(str(self.pw_out))
        self.mppt3_errorval.setText(str(self.pw_out))
        self.mppt3_mosfetval.setText(str(self.pw_out))
        self.mppt3_cntrlval.setText(str(self.pw_out))
        self.mppt3_pwrcntrlval.setText(str(self.pw_out))
        self.mppt3_aux12val.setText(str(self.pw_out))
        self.mppt3_aux3val.setText(str(self.pw_out))
        self.mppt3_output_batteryval.setText(str(self.pw_out))

        self.mppt4_modeval.setText(str(self.pw_out))
        self.mppt4_input_voltval.setText(str(self.pw_out))
        self.mppt4_input_currentval.setText(str(self.pw_out))
        self.mppt4_input_powerval.setText(str(self.pw_out))
        self.mppt4_limitsval.setText(str(self.pw_out))
        self.mppt4_output_voltval.setText(str(self.pw_out))
        self.mppt4_output_currentval.setText(str(self.pw_out))
        self.mppt4_output_powerval.setText(str(self.pw_out))
        self.mppt4_errorval.setText(str(self.pw_out))
        self.mppt4_mosfetval.setText(str(self.pw_out))
        self.mppt4_cntrlval.setText(str(self.pw_out))
        self.mppt4_pwrcntrlval.setText(str(self.pw_out))
        self.mppt4_aux12val.setText(str(self.pw_out))
        self.mppt4_aux3val.setText(str(self.pw_out))
        self.mppt4_output_batteryval.setText(str(self.pw_out))

        self.act_motorval.setText(str(self.pw_out))
        self.tri_idval.setText(str(self.pw_out))
        self.serial_noval.setText(str(self.pw_out))

        self.bus_voltval.setText(str(self.pw_out))
        self.bus_currval.setText(str(self.pw_out))
        self.bus_pwrval.setText(str(self.pw_out))
        self.rms_cval.setText(str(self.pw_out))
        self.rms_bval.setText(str(self.pw_out))

        self.rpmval.setText(str(self.pw_out))
        self.kphval.setText(str(self.pw_out))
        self.vdval.setText(str(self.pw_out))
        self.vqval.setText(str(self.pw_out))

        self.motor_tempval.setText(str(self.pw_out))
        self.hs_tempval.setText(str(self.pw_out))
        self.dsp_tempval.setText(str(self.pw_out))
        self.vd1val.setText(str(self.pw_out))
        self.vq1val.setText(str(self.pw_out))

        self.rail1val.setText(str(self.pw_out))
        self.rail2val.setText(str(self.pw_out))
        self.rail3val.setText(str(self.pw_out))
        self.idval.setText(str(self.pw_out))
        self.iqval.setText(str(self.pw_out))
